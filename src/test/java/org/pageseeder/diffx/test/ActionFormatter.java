...
public class ActionFormatter implements DiffXFormatter {
   ...
   */
  private final List<Action<XMLToken>> actions = new ArrayList<>();

  /**
   * The action used in the last operation.
   */
  private Action<XMLToken> action = null;
   ...
   * @see Operator#DEL
   */
  public void delete(XMLToken token) {
   ...
   */
  public List<Action<XMLToken>> getActions() {
    return this.actions;
  }
