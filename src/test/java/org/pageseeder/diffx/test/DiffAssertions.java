...
public final class DiffAssertions {
   ...
   */
  public static void assertActionsMatchEvents(List<? extends Token> tokens, List<Action<Token>> actions, boolean forward) {
   ...
   */
  public static void assertIsApplicable(List<? extends Token> seqA, List<? extends Token> seqB, List<Action<Token>> actions) {
   ...
   */
  public static void assertIsCorrect(List<? extends Token> seqA, List<? extends Token> seqB, List<Action<Token>> actions) {
   ...
   * Asserts that the list of actions lead to the correct XML
   */
  public static void assertIsCorrect(Sequence a, Sequence b, List<Action<Token>> actions) {
    // Apply actions to A to ensure we get B
  ...
  public static void assertIsWellFormedXML(List<Action<Token>> actions) {
    List<Action<Token>> wrapped = new ArrayList<>();
  ...
  public static void assertIsWellFormedXML(List<Action<Token>> actions, NamespaceSet namespaces) {
    List<Action<Token>> wrapped = new ArrayList<>();
    // We wrap the actions in case we have a completely different output
  ...
  public static void assertMatchTestOutput(List<Action<Token>> actions, String[] exp) {
  ...
  public static void assertMatchTestOutput(List<Action<Token>> actions, String[] exp, NamespaceSet namespaces) {
    // check the possible values
  ...
  public static String toTestOutput(List<Action<Token>> actions, NamespaceSet namespaces) {
    TestHandler handler = new TestHandler(namespaces);
    Actions.handle(actions, handler);
    return handler.getOutput();
  }

  public static String toTestOutput(List<Action<Token>> actions) {
