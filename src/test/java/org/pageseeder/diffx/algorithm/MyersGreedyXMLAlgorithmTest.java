 ...
 * @since 0.9.0
 */
public final class MyersGreedyXMLAlgorithmTest {

  private MyersGreedyXMLAlgorithm newAlgorithm() {
    return new MyersGreedyXMLAlgorithm();
  }
  ...
  public class EqualityDiff extends BasicEqualityAlgorithmTest {
    ...
    EqualityDiff() {
      super(MyersGreedyXMLAlgorithm::new);
    }
