...
/**
 * A snake is non-diagonal edge and then a possibly empty sequence of diagonal edges from the edit graph.
 *
...
public final class Snake {
  ...
  private Snake(int x, int y, Direction direction, int edited, int matching, int delta, int diff) {
    this.x = x;
    this.y = y;
  ...
  private Snake(int x, int y, Direction direction, int edited, int matching) {
    this(x, y, direction, edited, matching, 0, -1);
  }

  /**
   * Create a new Snake within the rectangle.
   */
  public static Snake create(int aStart, int aEnd, int bStart, int bEnd, Direction direction, int xStart, int yStart, int edited, int matching) {
    Snake snake = new Snake(xStart, yStart, direction, edited, matching);
  ...
  public String toString() {
    return "Snake " + direction + ": " + getStartPoint() + " + " +
        "(" + inserted() + ", " + deleted() + ")" +
